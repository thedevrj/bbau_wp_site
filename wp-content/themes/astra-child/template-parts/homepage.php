    ...
    <div class="info-grid">
      ...
      <div class="info-box">
        <div class="info-scroll">
          ...
          <a href="#" class="info-item">CUET-PG 2026 Information Bulletin</a>
          <a href="#" class="info-item">UG Admission Notice 2025–26</a>
          <a href="#" class="info-item">Examination Schedule Released</a>
          <a href="#" class="info-item">Revised Academic Calendar</a>
        </div>
        <a href="#" class="info-link">View All →</a>
      </div>
      ...
      <div class="info-box">
        ...
        <a href="#" class="info-link dark">View All →</a>
      </div>
