        ...
        <div class="container px-lg-3 px-0 pb-4 max_xl_w_1280 position-relative">
            <div class="row py-lg-2 py-3">
                <div class="col-lg-12">
                    ...
                    <h3 class="section-heading mb-3">Annual Reports</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($english_reports): ?>
                                            <a class="link-new"
                                               target="<?php echo $new_tab ? '_blank' : '_self'; ?>"
                                               href="<?php echo esc_url($english_reports); ?>">
                                                <i class="icon-file-pdf1"></i>
                                                <?php echo esc_html($report_title); ?> (English)
                                            </a>
                                        <?php endif; ?>
                                    </td>
                                        ...
                                        <?php if($hindi_reports): ?>
                                            <a class="link-new"
                                               ...
                                               href="<?php echo esc_url($hindi_reports); ?>">
                                                <i class="icon-file-pdf1"></i>
                                                <?php echo esc_html($report_title); ?> (Hindi)
                                            </a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                    ...
                    <h3 class="section-heading mb-3">Newsletter BBAU</h3>
                    ...
                    <h3 class="section-heading mb-3">Research Journals</h3>
