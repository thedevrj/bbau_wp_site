...
$designation     = esc_html($school['designation'] ?? '');
$dean_name       = esc_html($school['dean_name'] ?? '');
$dean_phone      = esc_html($school['dean_phone'] ?? '');
$dean_email      = esc_html($school['dean_email'] ?? '');
$dean_photo      = esc_url($school['dean_photo'] ?? '');
$description     = $school['description'] ?? '';
$board_url       = esc_url($school['board_url'] ?? '#');
$dean_url        = esc_url($school['dean_url'] ?? '#');
$specializations = esc_html($school['specializations'] ?? '');
$departments     = $school['departments'] ?? [];
?>

<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/schools-single.css">
...
<?php echo $name ?: 'Ambedkar School of Social Sciences'; ?>
</h3>
