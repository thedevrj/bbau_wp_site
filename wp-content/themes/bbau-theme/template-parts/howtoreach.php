...
/* ── RESET & BASE ── */
.bbau-reach-wrap *,
.bbau-reach-wrap *::before,
.bbau-reach-wrap *::after,
.bbau-hero *,
.bbau-hero *::before,
.bbau-hero *::after {
...
.bbau-card.bbau-train::before {
    background: #1a6fc4;
}

.bbau-card.bbau-road::before {
    background: #2e8b57;
}

.bbau-card.bbau-air::before {
    background: #9b59b6;
}

.bbau-card.bbau-bus::before {
    background: #e67e22;
}
...
.bbau-card.bbau-train .bbau-card-icon {
    background: #e8f0fb;
    color: #1a6fc4;
}

.bbau-card.bbau-road .bbau-card-icon {
    background: #e8f6ee;
    color: #2e8b57;
}

.bbau-card.bbau-air .bbau-card-icon {
    background: #f3eafa;
    color: #9b59b6;
}

.bbau-card.bbau-bus .bbau-card-icon {
    background: #fef3e2;
    color: #e67e22;
}
...
.bbau-card.bbau-train .bbau-badge {
    background: #e8f0fb;
    color: #1a6fc4;
}

.bbau-card.bbau-road .bbau-badge {
    background: #e8f6ee;
    color: #2e8b57;
}

.bbau-card.bbau-air .bbau-badge {
    background: #f3eafa;
    color: #9b59b6;
}

.bbau-card.bbau-bus .bbau-badge {
    background: #fef3e2;
    color: #e67e22;
}
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="bbau-reach-wrap">
                ...
                <!-- MAP BUTTON -->
                <a class="bbau-map-btn" href="<?php echo esc_url($bbau_maps_url); ?>" target="_blank"
                ...
                <div class="bbau-tip">
                    ...
                    <div>
                        ...
                        <div class="bbau-tip-text">
                            ...
                            Autos and e-rickshaws are available from Telibagh and Indira Nagar for the last mile to
                            campus.
                        </div>
                    </div>
                </div>
                ...
                <div class="bbau-map-section">
                    ...
                    <iframe class="bbau-map-embed" src="<?php echo esc_url($bbau_maps_embed); ?>" allowfullscreen=""
                        loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="BBAU Lucknow Campus Map">
                    </iframe>
                </div>
