...
if (!empty($notices)) {
    foreach ($notices as $n) {
        if (!empty($n['date'])) {
            $ts = strtotime($n['date']);
            if ($ts) {
                $bbau_phd_viva_years[(int) date('Y', $ts)] = true;
            }
        }
    }
    krsort($bbau_phd_viva_years);
    $bbau_phd_viva_years = array_keys($bbau_phd_viva_years);
}
        ...
        <?php else: ?>
            ...
            <div class="pb-filter-bar">
                ...
                <select id="pbYearFilter" class="pb-filter-select">
                    ...
                    <?php foreach ($bbau_phd_viva_years as $y): ?>
