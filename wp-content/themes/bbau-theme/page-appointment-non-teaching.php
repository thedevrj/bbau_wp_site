<?php
/**
 * Template Name: Appointment - Non-Teaching
 *
 * @package BBAU_Theme
 */
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="sc-search-wrap">
                        ...
                        <input type="text" id="notice-search" class="form-control"
                            placeholder="Search in Non-Teaching Appointments...">
                    </div>
                </div>
            ...
            <div class="col-12">
                <section class="sc-section">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="sc-section-title mb-0">Non-Teaching Appointments</h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const appointmentType = "Non-Teaching";
