...
$projects_url = $api_base . '/api/v1/research-projects/?department__slug=' . urlencode($slug) . '&campus=' . urlencode($dept_campus) . '&page_size=25';
...
$scholars_url = $api_base . '/api/v1/research-scholars/?department__slug=' . urlencode($slug) . '&campus=' . urlencode($dept_campus) . '&page_size=25';
...
$pubs_url = $api_base . '/api/v1/publications/?department__slug=' . urlencode($slug) . '&campus=' . urlencode($dept_campus) . '&page_size=25';
...
$patents_url = $api_base . '/api/v1/patents/?department__slug=' . urlencode($slug) . '&campus=' . urlencode($dept_campus) . '&page_size=25';
                ...
                <ul class="mini-patent-list">
                    ...
                    <li>
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 5px; gap: 10px;">
                            <strong style="line-height: 1.4; font-size: 0.95rem;"><?php echo esc_html($pat['title']); ?></strong>
