...
.faculty-card-premium:hover .faculty-image-wrap img {
    transform: scale(1.1);
}
...
.faculty-title-new {
    ...
    font-weight: 700;
    color: #b45309;
    /* Goldish-brown for academic title */
    margin-bottom: 15px;
}
...
.faculty-card-premium:hover .faculty-card-footer {
